...
console.log(vent.velocity === 0);
console.log(vent.rpm === 0);
vent.on = true; // should not be possible Igor: O resto do codigo funciona,
// mas o erro previne que o codigo rode, se comentar "vent.on = true"
// e "vent.velocity = 1" ele roda
console.log(vent.on === false);
console.log(vent.off === true);
console.log(vent.velocity === 0);
console.log(vent.rpm === 0);
